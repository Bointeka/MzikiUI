...
import VNavSearch from './VNavSearch.vue'
</script>
...
<template>
  <div class="navbar">
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          <path
            ...
            fill="#ffff15"
            style="--darkreader-inline-fill: var(--darkreader-background-ffff15, #909000)"
          ...
          <path
            ...
            fill="#ffff15"
            style="--darkreader-inline-fill: var(--darkreader-text-ffff15, #ffff28)"
            data-darkreader-inline-fill=""
          />
          <path
    ...
    <div class="navChild">
      <VNavSearch id="search" />
    </div>
    <div class="navChild">
      <div id="login">
        <a @click="$router.replace('/signUp')">Sign Up</a>
